/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 291e9b6778bfadbdc2690df4d965a048)
// Runtime types generated with workerd@1.20251001.0 2025-04-29 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		CONVEX_HTTP_ENDPOINT: string;
		ASSETS_SECRET: string;
		BUCKET: R2Bucket;
		QUEUE: Queue;
	}
}
